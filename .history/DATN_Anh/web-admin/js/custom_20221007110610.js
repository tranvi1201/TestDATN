...
function changeContentDecs() {
    ...
    document.getElementById('panel-body').innerHTML = "<div ><p><strong>Lưu ý:</strong> Đối với một số mặt hàng nhất định, Người bán cần cung cấp các thông tin sau tại mục "Mô tả sản phẩm" theo quy định của Nghị định 85/2021/NĐ-CP (Xem Hướng dẫn chi tiết <a  target=""><strong>tại đây</strong></a>)</p><p>- Số chứng nhận phê duyệt kiểu</p><p>- Khuyến cáo</p><p>- Hướng dẫn sử dụng</p><p>- Thông số kỹ thuật</p><p>- Thông tin cảnh báo</p></div>";
        document.getElementById('panel-guide').style.display = "block";
