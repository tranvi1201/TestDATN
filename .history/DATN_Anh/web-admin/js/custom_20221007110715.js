...
<div ><p><span>Cập nhật só lượng tồn kho thực tế của sản phẩm để tránh hủy/ trễ đơn hàng.</span></p><p><span>Xem thêm Quản lý tồn kho</span><a href="" target=""><strong> tại đây</strong></a></p></div>
...
function changeContentDecs() {
    ...
    document.getElementById('panel-body').innerHTML = "<div ><p><strong>Lưu ý:</strong> Đối với một số mặt hàng nhất định, Người bán cần cung cấp các thông tin sau tại mục <strong>Mô tả sản phẩm</strong> theo quy định của Nghị định 85/2021/NĐ-CP (Xem Hướng dẫn chi tiết <a  target=""><strong>tại đây</strong></a>)</p><p>- Số chứng nhận phê duyệt kiểu</p><p>- Khuyến cáo</p><p>- Hướng dẫn sử dụng</p><p>- Thông số kỹ thuật</p><p>- Thông tin cảnh báo</p></div>";
        document.getElementById('panel-guide').style.display = "block";

}
function changeContentBrand() {
    document.getElementById('panel-title').innerHTML = "Thương Hiệu";
    document.getElementById('panel-body').innerHTML = "<div ><p>Sản phẩm có thương hiệu:</p><p>- Chọn từ danh sách/đăng ký thương hiệu</p><p>Xem hướng dẫn Đăng ký Thương hiệu cho sản phẩm <a  target=""><strong>tại đây</strong></a></p><p>Sản phẩm không thương hiệu:</p><p>- Chọn </strong>No brand</strong></p><p><br></p><p>⚠️Sản phẩm Mall phải có thương hiệu</p></div>    ";
        document.getElementById('panel-guide').style.display = "block";
...
function changeContentQuantity() {
    ...
    document.getElementById('panel-body').innerHTML = "<div ><p><span>Cập nhật só lượng tồn kho thực tế của sản phẩm để tránh hủy/ trễ đơn hàng.</span></p><p><span>Xem thêm Quản lý tồn kho</span><a href="" target=""><strong> tại đây</strong></a></p></div> ";
        document.getElementById('panel-guide').style.display = "block";
