...
<div ><p><span>Cập nhật só lượng tồn kho thực tế của sản phẩm để tránh hủy/ trễ đơn hàng.</span></p><p><span>Xem thêm Quản lý tồn kho</span><a href="" ><strong> tại đây</strong></a></p></div>
...
function changeContentQuantity() {
    ...
    document.getElementById('panel-body').innerHTML = "<div ><p><span>Cập nhật só lượng tồn kho thực tế của sản phẩm để tránh hủy/ trễ đơn hàng.</span></p><p><span>Xem thêm Quản lý tồn kho</span><a href="" ><strong> tại đây</strong></a></p></div> ";
        document.getElementById('panel-guide').style.display = "block";
