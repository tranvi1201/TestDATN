...
function changeContentBrand() {
    ...
    document.getElementById('panel-body').innerHTML = "<div ><p>Sản phẩm có thương hiệu:</p><p>- Chọn từ danh sách/đăng ký thương hiệu</p><p>Xem hướng dẫn Đăng ký Thương hiệu cho sản phẩm <a  target=""><strong>tại đây</strong></a></p><p>Sản phẩm không thương hiệu:</p><p>- Chọn "No brand"</p><p><br></p><p>⚠️Sản phẩm Mall phải có thương hiệu</p></div>    ";
        document.getElementById('panel-guide').style.display = "block";
