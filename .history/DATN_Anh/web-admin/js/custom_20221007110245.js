...
<div ><p><span>Cập nhật só lượng tồn kho thực tế của sản phẩm để tránh hủy/ trễ đơn hàng.</span></p><p><span>Xem thêm Quản lý tồn kho</span><a href="" target="_blank"><strong> tại đây</strong></a></p></div>
...
function changeContentNamePro() {
    ...
    document.getElementById('panel-body').innerHTML = "<div ><p>Sản phẩm có thương hiệu:</p><p>- Chọn từ danh sách/đăng ký thương hiệu</p><p>Xem hướng dẫn Đăng ký Thương hiệu cho sản phẩm <a  target="_blank"><strong>tại đây</strong></a></p><p>Sản phẩm không thương hiệu:</p><p>- Chọn "No brand"</p><p><br></p><p>⚠️Sản phẩm Mall phải có thương hiệu</p></div>    ";
        document.getElementById('panel-guide').style.display = "block";
...
function changeContentQuantity() {
    ...
    document.getElementById('panel-body').innerHTML = "<div ><p><span>Cập nhật só lượng tồn kho thực tế của sản phẩm để tránh hủy/ trễ đơn hàng.</span></p><p><span>Xem thêm Quản lý tồn kho</span><a href="" target="_blank"><strong> tại đây</strong></a></p></div> ";
        document.getElementById('panel-guide').style.display = "block";
...
function changeContentPrice() {
    document.getElementById('panel-title').innerHTML = "Giá";
    document.getElementById('panel-body').innerHTML = "<div><p><span>Giảm Giá sản phẩm phải tính bằng đơn vị VNĐ</span></p><p><br></p><p><span>⚠️Lưu ý với bài đăng cho nhiều sản phẩm, Giá phải được phân loại rõ ràng dựa trên kích cỡ, màu sắc, chất lượng</span></p></div>    ";
        document.getElementById('panel-guide').style.display = "block";
