...
function changeContentNamePro() {
    ...
    document.getElementById('panel-body').innerHTML = "<div ><div ><div><p>- Tham khảo quy định đặt tên <strong>  
     </strong><a ><strong>tại đây</strong></a>.</p><p>- Với Shopee Mall, xem thêm quy định <a ><strong>tại đây</strong></a>.</p><p>Sử dụng tiếng Việt có dấu, không viết tắt, tối thiểu 10 ký tự, 20 ký tự đối với Shopee Mall. Độ dài tối đa của tên sản phẩm cho tất cả các Shop là 120 ký tự (bao gồm cả khoảng trắng).</p></div></div></div>";
        document.getElementById('panel-guide').style.display = "block";
